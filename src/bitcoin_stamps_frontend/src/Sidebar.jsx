  ...
  return (
    <Flex
      ...
      <HStack spacing={{ base: '0', md: '6' }}>
        <IconButton size="lg" variant="ghost" aria-label="open menu" icon={<FiBell />} color="white" />  {/* Set icon color */}
            ...
            <MenuButton py={2} transition="all 0.3s" _focus={{ boxShadow: 'none' }}>
              <HStack>
                ...
                <VStack
                  ...
                  ml="2">
                  <Text fontSize="sm" color="white">Internet Identity</Text> {/* Set text color */}
                  <Text fontSize="xs" color="white">
                    Connected
                  </Text>
                </VStack>
                <Box display={{ base: 'none', md: 'flex' }}>
                  <FiChevronDown color="white" />  {/* Ensure icon color is white */}
                </Box>
              </HStack>
            </MenuButton>
            <MenuList
              ...
              <MenuItem color="white">Billing</MenuItem>
              <MenuDivider />
              <MenuItem color="white">Sign out</MenuItem>
            </MenuList>
          </Menu>
        </Flex>
      </HStack>
